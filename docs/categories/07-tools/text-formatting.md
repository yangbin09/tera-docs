...
这是一个文字排版工具，能帮你把乱七八糟的文字整理得清晰美观。它会帮你设计标题、分段、突出重点、调整间距，让文章读起来更舒服、更好理解。
...
| 输入项 | 说明 | 示例 |
|--------|------|------|
| 原始文字 | 要排版的文章内容 | 直接粘贴文字 |
| 特殊要求 | 想要的排版风格（可选） | 简洁一些、重点更突出 |
| 使用场景 | 文档用途 | 公众号、朋友圈、工作汇报 |
