...
这是一个文案合规检查工具，能帮你找出文章中的违禁词并提供替换建议。检测完成后，会把违禁词加粗标出，并提供拼音、Emoji、同义词三种替换方案。
...
| 输入项 | 说明 | 示例 |
|--------|------|------|
| 文案内容 | 需要检查的完整文案 | 把你的文章复制过来 |
| 违禁词库 | 你已知的违禁词（可选） | 最好、第一、绝对 |
| 平台名称 | 主要发布平台 | 小红书、抖音 |
...
1. **违禁词标记**：原文案中的违禁词用**加粗**显示
2. **拼音替换**：用拼音字母替代违禁词
3. **Emoji替换**：用表情符号替代违禁词
4. **同义词替换**：用合规的近义词替代
5. **修改后文案**：完整的替换后版本
