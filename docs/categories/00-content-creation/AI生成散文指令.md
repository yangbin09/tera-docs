...
帮助你创作优美、富有情感深度的散文作品。AI会引导你从确定主题开始，经过结构设计、初稿生成、到最终优化润色，帮你写出一篇符合散文特点的文章。
...
| 步骤 | 需要提供的内容 | 说明 |
|------|---------------|------|
| 第1步 | 散文主题或情感基调 | 如"思念故乡"、"成长的烦恼"等 |
| 第2步 | 对结构的意见 | 确认或调整散文框架 |
| 第4步 | 修改意见 | 告诉AI哪些地方需要调整 |

## 6. 输出结果说明

- **散文主题**：明确的情感指向
- **结构设计**：引言、展开、转折（可选）、结尾的框架
- **散文初稿**：约500字
- **优化后散文**：标题+润色后的完整文章，语言优美有感情
...
核心约束：强调"有感情色彩、语句优美"，避免AI生硬感。

## 8. 使用注意事项

- **真情实感**：散文的核心是真实情感，不要堆砌华丽辞藻
- **结构清晰**：虽然散文"形散"，但神不能散
- **语言自然**：避免过于书面化的表达
- **适度煽情**：情感表达要自然，不要矫揉造作
