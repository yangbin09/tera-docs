---
title: 09 n8n 自动化工作流：从0到1（10节课入门大纲）
sidebarTitle: 09 n8n 入门大纲
---
# 09 n8n 自动化工作流：从0到1（10节课入门大纲）
...
实验 B (Webhook)： Webhook -> Set。复制 Webhook 的 Test URL，在浏览器中打开并添加查询参数（如 ?name=Bob）。在 Set 节点中，尝试获取 Bob 这个值：
